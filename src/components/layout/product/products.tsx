...
export default async function Home() {
  ...
  return (
    <main className="min-h-screen bg-gradient-to-r from-blue-50 via-green-50 to-yellow-50 flex justify-center items-center p-4">
          ...
          {data.map((item, index) => (
            ...
            >
              <div className="relative">
                ...
                />
                <span className="absolute top-2 left-2 bg-blue-600 text-white text-xs py-1 px-3 rounded-lg shadow-md">
                  New
                </span>
              </div>
              <div className="p-6">
